...
<body>
  <div class="app-wrap container">
    <div class="video-content">
      <div class="video-box">
        <!--
        <audio controls="true" class="full-control">
          <source src="<?php echo $data['url'];?>">
          您的浏览器不支持此类音频标签
        </audio>-->
        <audio preload="preload" controls id="car_audio" src="<?php echo $data['url'];?>" loop></audio>
        <!-- 必须加在微信api资源 -->
            ...
            <div class="comment-info">
              <div class="comment-body">
                <div class="comment-author clearfix">
                  ...
                  <div class="dates fr"><?php echo (date('Y-m-d H:i:s',$list['addtime'])); ?></div>
                </div>
