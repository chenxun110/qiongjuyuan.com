...
<body>
  <div class="app-wrap container">
   ...
   <form class="head-search" method="get" action="<?php echo U('Wap/Artice/troupelist');?>">
    ...
    <div class="list-group pt10"> 
          <?php if(is_array($list)): foreach($list as $key=>$list): ?><a href="<?php echo U('Wap/Artice/troupedetails',array('id'=>$list['id']));?>" class="list-group-item clearfix"><?php echo $list['title'];?><i class="pull-right fa fa-angle-double-right"></i></a><?php endforeach; endif; ?>
