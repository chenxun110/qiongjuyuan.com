...
<div class="main span10">
    <h4>编辑<a href="<?php echo U(GROUP_NAME.'/Schedule/index');?>" class="pull-right" ><i class="icon-backward"></i> <strong>返回列表</strong></a></h4>
<hr>
    <form action="<?php echo U(GROUP_NAME.'/Schedule/update');?>" method="post" accept-charset="utf-8" class="well form-inline" id="f" onSubmit="return qjy_ajaxform(this,function(d){opt_ok_return(d)})"> 
...
<tr>
        ...
        <tr>
          ...
          <td><input type="text" name="playtime" value="<?php echo $vo['playtime'];?>" id="playtime" class="span8"/></td>
        </tr>  
        <tr>
          <td width="25%"><label for="address">演出地点<font color="red">*</font></label></td>
          <td><input type="text" name="address" value="<?php echo $vo['address'];?>" id="address" class="span8"/></td>
        </tr>  
         <tr><td>
          <label for="discription">入场规定</label></td>
          <td><textarea name="rule" id="rule" class="input-autosave span8" ><?php echo $vo['rule'];?></textarea>                </td>
        </tr> 
         <tr><td>
        ...
        <tr>
          ...
          <td><input type="text" name="num" value="<?php echo $vo['num'];?>" id="num" class="span4"/></td>
        </tr>  
        <tr>
        ...
        <tr>
          ...
          <td>开始于<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss'})" name="start_time" value="<?php echo (date('Y-m-d H:i:s',$vo['start_time'])); ?>" id="start_time" class="span4"/>至
            <input type="text" name="end_time" onfocus="WdatePicker({dateFmt:'yyyy-M-d H:mm:ss',minDate:'#F{$dp.$D(\'start_time\')}'})" value="<?php echo (date('Y-m-d H:i:s',$vo['end_time'])); ?>" id="end_time" class="span4"/>结束</td>
        </tr>  
        <tr>
         ...
         <td><label for="title">状态<font color="red">*</font></label></td>
           <td>
           <input name="type" <?php if($vo['status'] == 0): ?>checked="checked"<?php endif; ?> value="0" type="radio">正常
           <input name="type" <?php if($vo['status'] == 1): ?>checked="checked"<?php endif; ?> value="1" type="radio">结束
         </td>
         </tr>     
        <tr><td></td>
