...
<div class="main span10">
    <h4>添加单图文<a href="<?php echo U(GROUP_NAME.'/Replynews/index');?>" class="pull-right" ><i class="icon-backward"></i> <strong>返回列表</strong></a></h4>
<hr>
    <form action="<?php echo U(GROUP_NAME.'/Replynews/update');?>" method="post" accept-charset="utf-8" class="well form-inline" id="f" onSubmit="return qjy_ajaxform(this,function(d){opt_ok_return(d)})"> 
      <table class="table table-bordered table-wordpress postlist-table">
        ...
        <tr>
          ...
          <td><input type="text" name="title" value="<?php echo ($vo['title']); ?>" id="title" class="span4"/></td>
        </tr> 
        <tr>
        ...
        <tr>
          ...
          <td><textarea name="description" class="span8"><?php echo ($vo['description']); ?></textarea></td>
        </tr> 
         <tr>
          <td><label for="title"> 图文封面 <font color="red">*</font></label></td>
          <td> <img src="<?php echo $vo['picurl'];?>" id="pic" style="height:60px;width:60px;"><br/><input type="text" name="picurl" value="<?php echo ($vo['picurl']); ?>" id="picurl" class="span4"  />
            <input type="button" value="选择图片" id="upload" class="btn btn-primary"></td>
        </tr>  
        <tr>
          <td><label for="content">内容 <font color="red">*</font></label></td>
          <td><textarea name="content" id="content" class="span8" style="height:380px;"><?php echo ($vo['content']); ?></textarea></td>
        </tr> 
         <tr>
          <td><label for="title">链接</label></td>
          <td><input type="text" name="url" value="<?php echo ($vo['url']); ?>" id="url" class="span4"/></td>
        </tr> 
        <tr><td></td>
