...
<a href="<?php echo U(GROUP_NAME.'/Audiocate/add');?>" class="btn btn-success"><i class="icon-plus icon-white"></i> 添加</a>
</div>
<h4>音频分类</h4>
<hr/>
    ...
    <tbody>
        ...
        <td>
          <div class="btn-toolbar">
            <div class="btn-group">
              <a href="<?php echo U(GROUP_NAME.'/Audiocate/edit',array('id'=>$list['id']));?>" class="btn btn-mini" ><i class="icon-edit"></i> 更改</a>
...
<script type="text/javascript">
 function status(id){
   $.post("<?php echo U(GROUP_NAME.'/Audiocate/ajax_status');?>",{'id':id},function(data){
        if(data.status==1){
