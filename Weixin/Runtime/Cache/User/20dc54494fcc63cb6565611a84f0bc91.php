...
<a href="<?php echo U(GROUP_NAME.'/Video/add');?>" class="btn btn-success"><i class="icon-plus icon-white"></i> 添加</a>
</div>
<h4>琼剧赏析</h4>
<hr/>
    ...
    <tbody>
        ...
        <td>
          <div class="btn-toolbar">
            <div class="btn-group">
              <a href="<?php echo U(GROUP_NAME.'/Video/edit',array('id'=>$list['id']));?>" class="btn btn-mini" ><i class="icon-edit"></i> 更改</a>
