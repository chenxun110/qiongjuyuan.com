...
<hr/>
  <table class="table table-bordered table-wordpress postlist-table">
    ...
    <tbody>
        ...
        <td><?php if($list['type'] == 1): ?>文本<?php elseif($list['type'] == 2): ?>单图文<?php elseif($list['type'] == 3): ?>多图文<?php else: ?>大转盘<?php endif; ?></td>
        <td><?php echo get_title($list['source_table'],$list['aim_id']);?></td>
