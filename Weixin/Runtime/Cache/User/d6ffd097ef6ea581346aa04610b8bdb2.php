...
<div class="main span10">
    <h4>添加多图文<a href="<?php echo U(GROUP_NAME.'/Muti/index');?>" class="pull-right" ><i class="icon-backward"></i> <strong>返回列表</strong></a></h4>
<hr>
    <form action="<?php echo U(GROUP_NAME.'/Muti/insert');?>" method="post" accept-charset="utf-8" class="well form-inline" id="f" onSubmit="return qjy_ajaxform(this,function(d){opt_ok_return(d)})"> 
      <table class="table table-bordered table-wordpress postlist-table">
        ...
        <tr>
          <td><label for="content">关联图文<font color="red">*</font></label></td>
          <td> <input type="button" value="选择图文" id="news" class="btn btn-primary">
            <hr/>
            <ul class="news span6">
...
<!--图文列表-->
<div id="newslist" class="modal hide fade"  tabindex="-1" style="width:800px;height:500px;" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-body">
    <iframe scrolling="no" marginheight="0" marginwidth="0" frameborder="0" style="height:1130px;width:100%;" src="<?php echo U(GROUP_NAME.'/Muti/selectenews');?>" ></iframe>
  </div>
</div>
<script type="text/javascript">
  $(function(){
  $(".del-news").live("click",function(){
    //写你的单击事件代码
